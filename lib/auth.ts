...
export const IN_APP_BROWSER_NOTICE_TITLE = '에브리타임 안에서는 Google 로그인이 불가능해요'
export const IN_APP_BROWSER_IOS_GUIDE = "우측 상단의 공유 버튼을 눌러 'Safari에서 열기'를 선택해주세요"
export const IN_APP_BROWSER_ANDROID_GUIDE = "우측 상단 메뉴를 눌러 'Chrome으로 열기'를 선택해주세요"
