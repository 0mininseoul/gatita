...
export const IN_APP_BROWSER_NOTICE_TITLE = '인앱 브라우저에서는 Google 로그인이 불가능해요'
export const IN_APP_BROWSER_NOTICE_BODY = '에브리타임처럼 앱에 내장된 브라우저는 Google 보안 정책상 로그인이 차단됩니다. 아래 버튼으로 Chrome 또는 Safari에서 열어주세요.'
export const IN_APP_BROWSER_IOS_GUIDE = '우측 상단의 ··· (또는 공유) 버튼을 눌러 "Safari로 열기"를 선택해주세요.'
